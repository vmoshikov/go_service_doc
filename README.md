...
**Для разработчиков:** требования к именованию веток/коммитов для CHANGELOG и к формату комментариев в коде для отображения в документации — см. [DEVELOPER_REQUIREMENTS.md](DEVELOPER_REQUIREMENTS.md).
